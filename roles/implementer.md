...
satisfies it — no more. What you produce goes to a [Critic](critic.md) and a
[Validator](validator.md) who are not you.
...
- **You receive from** [Explorer](explorer.md) (the territory), [Specialist](specialist.md)
  (how it must behave), or an accepted design.
- **You hand to** [Critic](critic.md) and [Validator](validator.md). Make the diff reviewable:
...
[O1](../docs/concepts/orchestration.md#o1--agents-propose-the-orchestrator-decides-the-artifact-commits) propose, do not decide ·
...
[O7](../docs/concepts/orchestration.md#o7--reject-output-computed-against-superseded-state) superseded state
