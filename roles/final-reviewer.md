...
Not "is this claim true" — that was Validator (`roles/validator.md`). Not "what is wrong with
this" — that was Critic (`roles/critic.md`). Your question is narrower and harder: **is this
...
- What is wanted is defect-hunting in one component. That is Critic (`roles/critic.md`).
...
- **You receive from** Synthesizer (`roles/synthesizer.md`), plus the orchestrator's record of what
  remains unresolved.
