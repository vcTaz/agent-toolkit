...
- A previous version needs revising after a [Final Reviewer](final-reviewer.md) verdict.
...
complete or final until an independent [Final Reviewer](final-reviewer.md) has judged it and
...
- **You hand to** [Final Reviewer](final-reviewer.md), which judges the exact version you
  produced.
...
[O19](../docs/concepts/orchestration.md#o19--synthesis-may-only-use-what-it-was-given) only what you were given ·
