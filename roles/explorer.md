...
- The work is to change something. That is [Implementer](implementer.md).
- The task is to attack an existing claim. That is [Critic](critic.md).
...
[Critic](critic.md) and [Validator](validator.md) must not be. Report clearly enough that
...
- **You hand to** [Critic](critic.md), which will attack your findings, and
  [Validator](validator.md), which will check them. Write so both can work without you.
- **You hand to** [Specialist](specialist.md) when your region turns out to need depth you
...
[O5](../docs/concepts/orchestration.md#o5--one-artifact-one-owner) one owner ·
[O6](../docs/concepts/orchestration.md#o6--parallelise-only-genuinely-independent-work) genuine independence ·
[O11](../docs/concepts/orchestration.md#o11--a-delivery-requests-reconsideration-it-never-proves-the-receiver-wrong) reconsideration ·
[O15](../docs/concepts/orchestration.md#o15--measure-progress-from-what-changed-not-what-was-claimed) measured progress
