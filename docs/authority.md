...
| `.claude-plugin/` | delivery — the two JSON manifests that make the repository root a Claude Code plugin | any definition; any component Claude Code would run by itself, which `tools/check.py` refuses |
