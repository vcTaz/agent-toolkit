...
- The claim can be settled by running something. Run it — that is
  Validator (`roles/validator.md`) work and it is stronger than criticism.
...
- **You receive from** Explorer (`roles/explorer.md`), Specialist (`roles/specialist.md`),
  Implementer (`roles/implementer.md`) — whoever produced the target.
- **You hand to** Validator (`roles/validator.md`). Your blocking issues become the Validator's
  checklist: it must name your exact issue identifiers to resolve them.
- **You are not** Final Reviewer (`roles/final-reviewer.md`). It judges the whole deliverable
